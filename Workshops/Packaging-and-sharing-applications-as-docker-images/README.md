...
#### Exact Commands for the exercise above
...
Once it is running you should see that it is available under <a href="http://localhost:5000" target="_blank">http://localhost:5000</a> (or see what Flask tells you in the terminal window, it should say "Running on URL: ..."). 

Navigate to this link in your browser and try out the app.
...
Once it is running you should see that it is available under <a href="http://localhost:3838" target="_blank">http://localhost:3838</a> (or see what the container tells you in the terminal window, it should say "Starting listener on: ..."). 
